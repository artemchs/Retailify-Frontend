...
export default function RemoveInventoryTransferReasonAlertDialog({
  id,
  setSelectedValue,
  selectedValue,
}: {
  ...
  const { mutate, isPending } = InventoryTransfers.useRemoveReason({
    setErrorMessage,
  ...
  return (
    <AlertDialog open={isOpened} onOpenChange={setIsOpened}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>
            Удалить причину перемещения товара
          </AlertDialogTitle>
          <AlertDialogDescription>
            Подтверждая это действие, информация о причине перемещения товара
