...
import CashierOrdersDialog from '@/features/orders/components/cash-register/CashierOrdersDialog'
...
export default function CurrentShiftDropdown({
    ...
    function ShiftStatusIcon({ className }: { className: string }) {
        return isLoading ? (
            ...
            <CheckCircle2
                className={cn('text-green-600 shrink-0', className)}
            />
        )
    }
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align='end'>
                    ...
                    <DropdownMenuItem
                        disabled={!isShiftOpened}
                        onClick={() =>
                            setIsDepositCashierShiftDialogOpened(true)
                        }
                    >
                    ...
                    <DropdownMenuItem
                        disabled={!isShiftOpened}
                        onClick={() =>
                            setIsWithdrawalCashierShiftDialogOpened(true)
                        }
                    >
